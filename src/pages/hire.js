    ...
    return (
        <div className="container">
            ...
            <div style={{ margin: 'auto', maxWidth: '500px' }}>
                ...
                <Form action="POST" data-netlify="true" className="shadow-lg p-5 mb-5 bg-white rounded">
                    <Form.Group>
                        <Form.Row>
                            <Col>
                    ...
                    <Form.Group controlId="exampleForm.ControlTextarea1">
                        <Form.Label>Send your message right here and i will get back</Form.Label>
                        <Form.Control as="textarea" name="message" id="message" rows="4" placeholder="short me this message.  ):" />
                    </Form.Group>

                    <Form.Group id="formGridCheckbox">
                        <Form.Check type="checkbox" label="I'm not a robot" data-netlify-recaptcha="true" />
                    </Form.Group>
